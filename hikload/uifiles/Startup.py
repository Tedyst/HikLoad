...
class Ui_Startup(object):
    def setupUi(self, Startup):
        ...
        self.start_date.setDate(QtCore.QDate(2021, 12, 28))
        ...
        self.end_date.setDate(QtCore.QDate(2022, 12, 27))
        ...
        self.concat = QtWidgets.QCheckBox(Startup)
        self.concat.setObjectName("concat")
        self.verticalLayout.addWidget(self.concat)
        self.trim = QtWidgets.QCheckBox(Startup)
        self.trim.setObjectName("trim")
        self.verticalLayout.addWidget(self.trim)
    ...
    def retranslateUi(self, Startup):
        ...
        self.concat.setText(_translate("Startup", "Concatenate all recordings per camera"))
        self.trim.setText(_translate("Startup", "Trim recordings only to specified times"))
