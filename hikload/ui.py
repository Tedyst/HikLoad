...
class Startup(QtWidgets.QDialog):
    def __init__(self, parent=None, args=None):
        ...
        self.ui.downloads_folder_button.clicked.connect(self.select_download_folder)
        self.ui.test_connection_button.clicked.connect(self.test_connection)
        self.ui.start_downloading_button.clicked.connect(self.start_downloading)
    ...
    def populate_with_args(self, args=None):
        ...
        self.ui.folder_behavior.setCurrentIndex(list.index([None, 'onepercamera', 'oneperday', 'onepermonth', 'oneperyear'], args.folders))
        if args.photos:
            self.ui.download_type.setCurrentIndex(1)
        self.ui.video_format.setCurrentIndex(list.index(['mkv', 'mp4', 'avi'], args.videoformat))
    ...
    def get_args(self):
        ...
        self.args.folders = [None, 'onepercamera', 'oneperday', 'onepermonth', 'oneperyear'][self.ui.folder_behavior.currentIndex()]
        self.args.photos = self.ui.download_type.currentIndex() == 1
        self.args.videoformat = ['mkv', 'mp4', 'avi'][self.ui.video_format.currentIndex()]
